...
Namespace MapInfoPhotoGPSPlotter
    Public Class Controller
        ...
        Private Const STR_APP_DOCK_INFO_NODE As String = "GPSExtractorDockPosInfo"
        '' file with path for docking persistence
        Private sDockInfoXMLFile As String = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MapInfo\\MapInfo\\Professional\\" + InteropHelper.GetAppVersion() + "\\GPSExtractor_dockinfo.xml"

        Private Shared _Dlg As Dlg = Nothing     '' GPSExtractor dialog
        ...
        Private Const controllerMutexName As String = "GPSExtractor.GPSExtractorDockController" '' Name of the mutex
        ...
        ''' <summary>
        ''' This function is called from MapBasic code
        ''' to display the GPSExtractor dialog.
        ''' </summary>
        ''' <param name="hMainWnd"></param>
        ''' <returns></returns>
        ...
        ''' <summary>
        ''' This function is called from MapBasic code
        ''' to close the GPSExtractor dialog before exiting.
        ''' </summary>
        Public Shared Function CloseDlg() As Boolean
            ...
            End If
            If _Dlg IsNot Nothing Then
                '' Clean up the GPSExtractor dialog
                _Dlg.Dispose()
            End If
        ...
        ''' <summary>
        ''' Close the dockable usercontrol(GPSExtractor Dialog)
        ''' </summary>
        ...
        ''' <summary>
        ''' get the open/close status of dockable user controlGPSExtractor dialog)
        ''' </summary>
